...
class ConvBlock(nn.Module):
    def __init__(self, in_channel, out_channel, kernel_size, padding, kernel_size2=None, padding2=None, pixel_norm=True):
        ...
        # Channel Attention após a primeira convolução
        ...
        # Spatial Attention após a segunda convolução
    ...
    def forward(self, input):
        #out = self.conv(input)
        # usar checkpoint para reduzir memória
        #return checkpoint(self.conv, input)
        #return out
